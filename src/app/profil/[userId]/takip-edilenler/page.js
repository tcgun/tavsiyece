    ...
    useEffect(() => {
        const fetchFollowing = async () => {
            ...
            try {
                ...
                // Takip edilenleri çek
                const followingList = await getFollowing(userId, 1000);
                setFollowing(followingList.map(user => ({
                    id: user.id,
                    name: user.name,
                ...
                console.error("Takip edilenler çekilirken hata:", err);
            } finally {
                setLoading(false);
            }
        };
            ...
            <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 p-3 sm:p-4 lg:p-6 max-w-7xl mx-auto">
                ...
                <main className="flex-1">
                    <div className="bg-card border border-border rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-xl">
                        <h1 className="text-2xl font-bold text-light mb-6">Takip Edilenler</h1>
                        ...
                        {following.length > 0 ? (
                            ...
                            <div className="text-center py-20">
                                ...
                                <p className="text-muted">Bu kullanıcı kimseyi takip etmiyor.</p>
                            </div>
                        )}
                    </div>
                </main>
